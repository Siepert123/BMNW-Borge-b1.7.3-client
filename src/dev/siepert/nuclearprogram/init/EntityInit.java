...
public class EntityInit {
	public static void register() {
		...
		GameRegistries.ENTITIES.register(NuclearProgram.MODID + "/ExplosionHelper", EntityExplosionHelper.class);

		System.out.println("HowitzerShell id: " + GameRegistries.ENTITIES.wrapper.classToIDMap.get(EntityHowitzerShell.class));
		System.out.println("ExplosionHelper id: " + GameRegistries.ENTITIES.wrapper.classToIDMap.get(EntityExplosionHelper.class));
	}
}
